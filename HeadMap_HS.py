...
for layer_idx in knowledge_circuit:
    ...
    def forward(
            ...
            **kwargs,
            ...
            return attn_output, None, past_key_value, residual_output
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Self Attention
        hidden_states, self_attn_weights, present_key_value, residual_output = self.self_attn(
        ...
        hidden_states = residual + hidden_states + residual_output * args.scaling
    ...
    model.model.layers[int(layer_idx)].forward = MethodType(forward, model.model.layers[int(layer_idx)])
...
lm = lm_eval.models.get_model('hf-causal-experimental').create_from_arg_string(f'pretrained={base_model}', {"batch_size": 16, "device": 'cuda'})
lm.model = model
lm.model.eval()
